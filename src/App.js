...
var white1 = {
  title: "To the worthiest Lady Mrs. Bridget White.",
  text:
...
var white2 = {
  title: "To the worthiest Lady Mrs. B. W.",
  text:
...
class App extends Component {
  ...
  setDocumentPreviewState(document) {
    return <DocumentPreview title={document.title} author={document.author} />;
  }

  createDocumentRoute(document) {
    return (
      <Route
        exact
        path={document.path}
        render={() => (
          <div>
            <Header />
            <div className="App">
              <DocumentPage title={document.title} text={document.text} />
            </div>
          </div>
        )}
      />
  ...
  render() {
    return (
      <BrowserRouter>
        {this.createDocumentRoute(gherard3)}
        {this.createDocumentRoute(unknown4)}
        {this.createDocumentRoute(white1)}
        {this.createDocumentRoute(white2)}
        {this.createDocumentRoute(wotton5)}
        {this.createDocumentRoute(wotton6)}
        <Route
          exact
          path={"/"}
          render={() => (
